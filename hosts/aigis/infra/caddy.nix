...
let
  caddyfile = pkgs.writeText "Caddyfile" ''
    *.laufin.xyz {
      secrets {
        file user ${config.sops.secrets.namecheap_api_user.path}
        file api_key ${config.sops.secrets.namecheap_api_key.path}
      }
  ...
  services.caddy = {
    ...
    package = pkgs.caddy.withPlugins {
      plugins = [
        ...
        "github.com/ben-freke/caddy-file-secrets@v0.0.0-20250810062743-fa950ded449b"
      ];
      hash = "";
    };
