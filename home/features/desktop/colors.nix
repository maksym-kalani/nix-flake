# Shared color definitions for the desktop environment
# Material Design 3 color palette
# All desktop components use these colors for consistency
{
  # Background colors
  background = "#121318";
  ...
  onSurfaceRgba = "rgba(e3e1e9ff)";

  # Primary colors
  primary = "#b8c3ff";
  primaryRgba = "rgba(b8c3ffff)";
